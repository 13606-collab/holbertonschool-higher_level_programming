...
class Node:
    ...
    def get_leaves_below(self):
        ...
        Returns:
            list: A list containing every `Leaf` object found in the
...
class Leaf(Node):
    ...
    def get_leaves_below(self):
        """Return the list of leaves below this leaf.

        Returns:
            list: A list containing only this leaf, since a leaf has
            no children.
        """
        return [self]
...
class Decision_Tree():
    ...
    def get_leaves(self):
        ...
        Returns:
            list: A list containing every `Leaf` object in the tree.
        """
