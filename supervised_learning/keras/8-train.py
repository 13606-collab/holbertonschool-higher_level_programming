...
def train_model(
    ...
    """Train a model using mini-batch gradient descent, analyze
    validation data if provided, use early stopping if requested,
    decay the learning rate if requested, and save the best
    iteration of the model if requested.
    ...
    Args:
        ...
        learning_rate_decay (bool): indicates whether learning rate
            ...
            decay, in a stepwise fashion after each epoch. Each time
            the learning rate updates, Keras should print a message.
    ...
    if learning_rate_decay and validation_data is not None:
        def scheduler(epoch):
            """Compute the learning rate using inverse time decay."""
